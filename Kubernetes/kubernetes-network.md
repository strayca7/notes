...
* **第三方插件**：Flannel、[Calico](kubernetes-network.md#calico)、Cilium、OVM 等等。

### CNI 工作流程

![cni-working-procedure.drawio](../.gitbook/assets/cni-working-procedure.drawio.svg)
...
![calico-architecture](../.gitbook/assets/calico-architecture.svg)

![calico-architecture](../.gitbook/assets/calico-architecture.png)
...
![vxlan-package.drawio](../.gitbook/assets/vxlan-package.drawio.svg)

VXLAN 封装的是 **源 VTEP 的 MAC 地址** 和 **目标 VTEP 的 MAC 地址**。

**工作流程**

![calico-working-procedure.drawio](../.gitbook/assets/vxlan-working-procedure.drawio.svg)
...
![ipip-package.drawio](../.gitbook/assets/ipip-package.drawio.svg)

**工作流程**

![ipip-working-procedure.drawio](../.gitbook/assets/ipip-working-procedure.drawio.svg)
...
![bgp-working-procedure.drawio](../.gitbook/assets/bgp-working-procedure.drawio.svg)
